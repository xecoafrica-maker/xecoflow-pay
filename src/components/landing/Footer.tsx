        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-10 lg:gap-12 mb-20">
          ...
          <div className="col-span-1 md:col-span-3">
            ...
            <div className="flex flex-wrap items-center gap-2.5 mt-6">
              ...
              <a href="#" aria-label="YouTube" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/[0.06] border border-white/[0.08] text-[#adbbca]/80 hover:text-white hover:bg-white/[0.1] transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
