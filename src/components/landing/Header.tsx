    ...
    <>
      ...
      {isPinModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          {/* Modal Content - Made to look more human/standard */}
          <div className="relative bg-[#FAFAFA] w-full max-w-[440px] rounded-2xl shadow-xl border border-gray-200 p-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            {/* Info Box - Softer, less saturated color */}
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white border border-gray-300 rounded-lg px-3.5 py-2.5 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] transition-all"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full bg-white border border-gray-300 rounded-lg px-3.5 py-2.5 text-gray-900 appearance-none focus:outline-none focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] transition-all cursor-pointer">
              ...
              {/* Button - Standard rounded rectangle instead of pill */}
              <button className="w-full bg-[#22C55E] hover:bg-[#1ea34d] text-white font-semibold text-base py-3 rounded-lg transition-all shadow-sm flex items-center justify-center gap-2 mt-2">
                Find My KRA PIN
